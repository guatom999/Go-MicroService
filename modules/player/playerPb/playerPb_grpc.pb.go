...
type PlayerGrpcServiceClient interface {
	CredetialSearch(ctx context.Context, in *CredetialSearchReq, opts ...grpc.CallOption) (*PlayerProfile, error)
	...
	GetPlayerSavingAccount(ctx context.Context, in *GetPlayerSavingAccountReq, opts ...grpc.CallOption) (*PlayerSavingAccount, error)
}
...
func (c *playerGrpcServiceClient) CredetialSearch(ctx context.Context, in *CredetialSearchReq, opts ...grpc.CallOption) (*PlayerProfile, error) {
	out := new(PlayerProfile)
	err := c.cc.Invoke(ctx, "/PlayerGrpcService/CredetialSearch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *playerGrpcServiceClient) GetPlayerSavingAccount(ctx context.Context, in *GetPlayerSavingAccountReq, opts ...grpc.CallOption) (*PlayerSavingAccount, error) {
	out := new(PlayerSavingAccount)
	err := c.cc.Invoke(ctx, "/PlayerGrpcService/GetPlayerSavingAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PlayerGrpcServiceServer interface {
	CredetialSearch(context.Context, *CredetialSearchReq) (*PlayerProfile, error)
	FindOnePlayerProfileToRefresh(context.Context, *FindOnePlayerProfileToRefreshReq) (*PlayerProfile, error)
	GetPlayerSavingAccount(context.Context, *GetPlayerSavingAccountReq) (*PlayerSavingAccount, error)
...
func (UnimplementedPlayerGrpcServiceServer) CredetialSearch(context.Context, *CredetialSearchReq) (*PlayerProfile, error) {
...
func (UnimplementedPlayerGrpcServiceServer) GetPlayerSavingAccount(context.Context, *GetPlayerSavingAccountReq) (*PlayerSavingAccount, error) {
...
func _PlayerGrpcService_CredetialSearch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CredetialSearchReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlayerGrpcServiceServer).CredetialSearch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PlayerGrpcService/CredetialSearch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlayerGrpcServiceServer).CredetialSearch(ctx, req.(*CredetialSearchReq))
	}
...
func _PlayerGrpcService_GetPlayerSavingAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PlayerGrpcService/GetPlayerSavingAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _PlayerGrpcService_CredetialSearch_Handler,
		},
		{
